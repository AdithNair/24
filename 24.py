...
open_img = ImageTk.PhotoImage(Image.open ("save.png"))
open_img = ImageTk.PhotoImage(Image.open ("exit.png"))
...
my_text.place(trlx=0.5,rely=0.55,anchpr= CENTER)

open_buyyon=Button(rppt,image-open_img,text="OpenFile", command=openFile )
